...
class AIProvider(ABC):
    @abstractmethod
    def generate_response(self, system_prompt: str, user_prompt: str, model: Optional[str] = None) -> str:
...
class MistralProvider(AIProvider):
    def __init__(self, api_key: str = None, model_name: str = None):
        ...
        self.default_model = model_name or "mistral-small-2603"
...
class OpenAIProvider(BaseOpenAIProvider):
    def __init__(self, api_key: str = None, model_name: str = None):
        super().__init__(api_key=api_key, base_url=None, default_model=model_name)
...
class XAIProvider(BaseOpenAIProvider):
    def __init__(self, api_key: str = None, model_name: str = None):
        ...
        super().__init__(api_key=key, base_url="https://api.x.ai/v1", default_model=model_name or "grok-beta")
...
class DeepSeekProvider(BaseOpenAIProvider):
    def __init__(self, api_key: str = None, model_name: str = None):
        ...
        super().__init__(api_key=key, base_url="https://api.deepseek.com", default_model=model_name or "deepseek-chat")


class LocalProvider(BaseOpenAIProvider):
    def __init__(self, api_key: str = "ollama", base_url: str = None, model_name: str = None):
        ...
        super().__init__(api_key=api_key, base_url=base_url, default_model=model_name or "llama3")
...
class AnthropicProvider(AIProvider):
    def __init__(self, api_key: str = None, model_name: str = None):
        ...
        self.default_model = model_name or "claude-3-opus-20240229"
...
class HuggingFaceProvider(AIProvider):
    def __init__(self, api_key: str = None, model_name: str = None):
        ...
        self.default_model = model_name or "meta-llama/Llama-2-70b-chat-hf" # Example default
...
class ProviderFactory:
    ...
    def get_provider(provider_name: str, **kwargs) -> AIProvider:
        ...
        if provider_name == "mistral":
            return MistralProvider(api_key=kwargs.get("api_key"), model_name=model_name)
        elif provider_name == "openai":
            return OpenAIProvider(api_key=kwargs.get("api_key"), model_name=model_name)
        elif provider_name == "anthropic":
            return AnthropicProvider(api_key=kwargs.get("api_key"), model_name=model_name)
        elif provider_name == "xai":
            return XAIProvider(api_key=kwargs.get("api_key"), model_name=model_name)
        elif provider_name == "deepseek":
            return DeepSeekProvider(api_key=kwargs.get("api_key"), model_name=model_name)
        elif provider_name == "huggingface":
            return HuggingFaceProvider(api_key=kwargs.get("api_key"), model_name=model_name)
