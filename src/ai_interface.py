...
class XAIProvider(BaseOpenAIProvider):
    def __init__(self, api_key: str = None):
        ...
        super().__init__(api_key=key, base_url="https://api.x.ai/v1", default_model="grok-beta")
...
class DeepSeekProvider(BaseOpenAIProvider):
    def __init__(self, api_key: str = None):
        ...
        super().__init__(api_key=key, base_url="https://api.deepseek.com", default_model="deepseek-chat")


class LocalProvider(BaseOpenAIProvider):
    def __init__(self, api_key: str = "ollama", base_url: str = None, default_model: str = "llama3"):
